const metadata = {
  name: 'Alonso Diaz Ruben Lautaro',
  description: 'Welcome to my personal portfolio where I show my projects.',
...
{
  web: 'Linkedin',
  link: 'https://www.linkedin.com/in/ruben-diaz-80850728b/',
  abbreviation: 'in'
}
]

export { metadata, redes }